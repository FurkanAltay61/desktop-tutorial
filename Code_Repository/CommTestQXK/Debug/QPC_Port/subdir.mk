...
QPC_Port/%.o QPC_Port/%.su: ../QPC_Port/%.c QPC_Port/subdir.mk
...
clean: clean-QPC_Port

clean-QPC_Port:
	-$(RM) ./QPC_Port/qf_port.d ./QPC_Port/qf_port.o ./QPC_Port/qf_port.su

.PHONY: clean-QPC_Port
