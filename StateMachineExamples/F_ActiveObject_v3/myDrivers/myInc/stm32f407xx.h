...
#ifndef MYINC_STM32F407XX_H_
#define MYINC_STM32F407XX_H_
...
#define DMA1_Stream0		((DMA_Stream_t*)DMA1_Stream0_BASEADDR)
#define DMA1_Stream1		((DMA_Stream_t*)DMA1_Stream1_BASEADDR)
#define DMA1_Stream2		((DMA_Stream_t*)DMA1_Stream2_BASEADDR)
#define DMA1_Stream3		((DMA_Stream_t*)DMA1_Stream3_BASEADDR)
#define DMA1_Stream4		((DMA_Stream_t*)DMA1_Stream4_BASEADDR)
#define DMA1_Stream5		((DMA_Stream_t*)DMA1_Stream5_BASEADDR)
#define DMA1_Stream6		((DMA_Stream_t*)DMA1_Stream6_BASEADDR)
#define DMA1_Stream7		((DMA_Stream_t*)DMA1_Stream7_BASEADDR)

#define DMA2				((DMA_RegDef_t*)DMA2_BASEADDR)
#define DMA2_Stream0		((DMA_Stream_t*)DMA2_Stream0_BASEADDR)
#define DMA2_Stream1		((DMA_Stream_t*)DMA2_Stream1_BASEADDR)
#define DMA2_Stream2		((DMA_Stream_t*)DMA2_Stream2_BASEADDR)
#define DMA2_Stream3		((DMA_Stream_t*)DMA2_Stream3_BASEADDR)
#define DMA2_Stream4		((DMA_Stream_t*)DMA2_Stream4_BASEADDR)
#define DMA2_Stream5		((DMA_Stream_t*)DMA2_Stream5_BASEADDR)
#define DMA2_Stream6		((DMA_Stream_t*)DMA2_Stream6_BASEADDR)
#define DMA2_Stream7		((DMA_Stream_t*)DMA2_Stream7_BASEADDR)
...
/*
 * Bit position definitions DMA_LIFCR
 */

#define DMA_LIFCR_CFEIF0			0
#define DMA_LIFCR_RESERVED			1
...
/*
 * Bit position definitions DMA_HIFCR
 */

#define DMA_HIFCR_CFEIF4			0
#define DMA_HIFCR_RESERVED5			1
...
#define DMA_SPAR_PAR1				0
#define DMA_SPAR_PAR2				16
...
#define DMA_SM0AR_M0A1				0
#define DMA_SM0AR_M0A2				16

/*
 * Bit position definitions DMA_SxM1AR
 */

#define DMA_SM1AR_M1A1				0
#define DMA_SM1AR_M1A2				16
...
#define	DMA_PERTOMEM				(uint32_t)0x0U
#define DMA_MEMTOPER				(uint32_t)(0x1UL << DMA_SCR_DIR)
#define DMA_MEMTOMEM				(uint32_t)(0x2UL << DMA_SCR_DIR)

/*
 * Dma Peripheral Incremental Mode
 */

#define DMA_PINC_EN					(uint32_t)(0x1UL << DMA_SCR_EN)
#define DMA_PINC_DIS				(uint32_t)0x0U

/*
 * DMA_Memory Incremental Mode
 */

#define DMA_MINC_EN					(uint32_t)(0x1UL << DMA_SCR_MINC)
#define DMA_MINC_DIS				(uint32_t)(0x0U)

/*
 * DMA_Peripheral_Data_Align
 */

#define DMA_PDATAALIGN_BYTE			(uint32_t)0x0U
#define DMA_PDATAALIGN_HWORD		(uint32_t)(0x1UL << DMA_SCR_PSIZE)
#define DMA_PDATAALIGN_WORD			(uint32_t)(0x2UL << DMA_SCR_PSIZE)
...
#define DMA_MDATAALIGN_BYTE			(uint32_t)0x0U
#define DMA_MDATAALIGN_HWORD		(uint32_t)(0x1UL << DMA_SCR_MSIZE)
#define DMA_MDATAALIGN_WORD			(uint32_t)(0x2UL << DMA_SCR_MSIZE)
...
#define DMA_NORMAL					(uint32_t)0x0U
#define DMA_CIRCULAR				(uint32_t)(0x1UL << DMA_SCR_CIRC)
#define DMA_PFCTRL					(uint32_t)(0x1UL << DMA_SCR_PFCTRL)

/*
 * DMA_Priority Level
 */

#define DMA_PRIO_LOW				(uint32_t)0x0U
#define DMA_PRIO_MED				(uint32_t)(0x1UL << DMA_SCR_PL)
#define DMA_PRIO_HIGH				(uint32_t)(0x2UL << DMA_SCR_PL)
#define DMA_PRIO_VERYHIGH			(uint32_t)(0x3UL << DMA_SCR_PL)

/*
 * DMA_Fifo_Direct_Mode
 */

#define DMA_FIFO_DIS				(uint32_t)0x0U
#define DMA_FIFO_EN					(uint32_t)(1 << DMA_SFCR_DMDIS)
...
#define DMA_IT_TC					(uint32_t)(1 << DMA_SCR_TCIE)
#define DMA_IT_HT					(uint32_t)(1 << DMA_SCR_HTIE)
#define DMA_IT_TE					(uint32_t)(1 << DMA_SCR_TEIE)
#define DMA_IT_DME					(uint32_t)(1 << DMA_SCR_DMEIE)
#define DMA_IT_FE					(uint32_t)(1 << DMA_SFCR_FEIE)
